...
daemon は workspace、repository、project、session、agent-profile、optional な tool-id scope に対して、inspect / update / history の settings operation を公開します。各 persistent update は actor、reason、old defaults、new defaults、timestamp を記録します。
