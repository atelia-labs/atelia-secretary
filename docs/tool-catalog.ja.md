...
[Tool Definition Schema](tool-definition-schema.ja.md)、[Tool Output Schema](tool-output-schema.ja.md)、[Extensions Runtime](extensions-runtime.ja.md)、Atelia の [Extension Composition](https://github.com/atelia-labs/atelia/blob/main/docs/extension-composition.ja.md)、[Agent Repertoire](https://github.com/atelia-labs/atelia/blob/docs/agent-repertoire/docs/agent-repertoire.ja.md) も参照します。Agent Repertoire は agent が現在の context で見られる live tool surface の computed projection です。
