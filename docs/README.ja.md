...
Atelia 全体の product philosophy、client UX、AEP package 仕様、Surface Protocol、Hook、governance は [`atelia`](https://github.com/atelia-labs/atelia/blob/main/README.ja.md) に置きます。この repository では、それらの contract を Secretary daemon がどう実装するかを定義します。
...
14. [AEP Package Runtime](extensions-runtime.ja.md)
...
- [Agent Repertoire](https://github.com/atelia-labs/atelia/blob/main/docs/agent-repertoire.ja.md) - 現在の context にある live tool surface の computed projection
