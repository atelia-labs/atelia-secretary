...
Agent が現在の context にある live tool surface の computed projection については [Agent Repertoire](https://github.com/atelia-labs/atelia/blob/main/docs/agent-repertoire.ja.md) を参照します。`ListRepertoire` はその projection の最初の beta protocol slice として予定されています。
