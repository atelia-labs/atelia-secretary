...
`ListRepertoire` は [Agent Repertoire](https://github.com/atelia-labs/atelia/blob/docs/agent-repertoire/docs/agent-repertoire.ja.md) の最初の beta protocol slice として予定されています。persisted store ではなく computed projection を返します。
## Core Messages
