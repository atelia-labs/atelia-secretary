...
- `capabilities`: この daemon が持つ named protocol capability
...
- severity
- public message
- job、policy decision、tool invocation、tool result、audit record への ref
...
transport error も client に届く時点では同じ shape に包みます。
