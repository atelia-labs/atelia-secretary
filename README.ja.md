...
- [MDP Runtime Contract](docs/mdp-runtime-contract.ja.md)
...
Atelia Secretary は初期設計と first product 実装の段階です。まずは Rust daemon、型付きプロトコル、policy、job orchestration、extension runtime、Hook 実行境界を、小さくても信頼できる MDP として固めていきます。
